...
const (
	...
	// CTenantCRDName is the full name of the CiliumTenant CRD.
	CTenantCRDName = k8sconstv2alpha1.CTenantKindDefinition + "/" + k8sconstv2alpha1.CustomResourceDefinitionVersion
)
...
func CustomResourceDefinitionList() map[string]*CRDList {
	return map[string]*CRDList{
		...
		synced.CRDResourceName(k8sconstv2alpha1.CTenantName): {
			Name:     CTenantCRDName,
			FullName: k8sconstv2alpha1.CTenantName,
		},
	}
}
...
var (
	...
	//go:embed crds/v2alpha1/ciliumtenants.yaml
	crdsv2Alpha1CiliumTenants []byte
)
...
func GetPregeneratedCRD(logger *slog.Logger, crdName string) apiextensionsv1.CustomResourceDefinition {
	...
	case CTenantCRDName:
		crdBytes = crdsv2Alpha1CiliumTenants
	default:
