...
func (in *AccessLogs) DeepEqual(other *AccessLogs) bool {
	if other == nil {
		return false
	}

	if in.Format != other.Format {
		return false
	}
	if ((in.JSON != nil) && (other.JSON != nil)) || ((in.JSON == nil) != (other.JSON == nil)) {
		in, other := &in.JSON, &other.JSON
		if other == nil {
			return false
		}
	...
	if ((in.Targets != nil) && (other.Targets != nil)) || ((in.Targets == nil) != (other.Targets == nil)) {
		in, other := &in.Targets, &other.Targets
		if other == nil {
			return false
		}
...
func (in *CiliumGatewayClassConfigSpec) DeepEqual(other *CiliumGatewayClassConfigSpec) bool {
	...
	if (in.Telemetry == nil) != (other.Telemetry == nil) {
		return false
	} else if in.Telemetry != nil {
		if !in.Telemetry.DeepEqual(other.Telemetry) {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumTenant) DeepEqual(other *CiliumTenant) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *Telemetry) DeepEqual(other *Telemetry) bool {
	if other == nil {
		return false
	}

	if ((in.AccessLogs != nil) && (other.AccessLogs != nil)) || ((in.AccessLogs == nil) != (other.AccessLogs == nil)) {
		in, other := &in.AccessLogs, &other.AccessLogs
		if other == nil {
			return false
		}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *TenantEgressGateway) DeepEqual(other *TenantEgressGateway) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *TenantSpec) DeepEqual(other *TenantSpec) bool {
	if other == nil {
		return false
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *TenantStatus) DeepEqual(other *TenantStatus) bool {
	if other == nil {
		return false
	}

	if in.TenantID != other.TenantID {
		return false
	}
